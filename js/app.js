    ...
    (() => {
        ...
        function rangeInit() {
            ...
            nouislider.create(slider, {
                ...
                pips: {
                    mode: "values",
                    values: [ 1959, 1975, 1991, 2006, 2022 ],
                    density: 3
                },
                range: {
                    min: 1959,
        ...
        da.init();
        const topheadeSearch = document.querySelector(".top-header__search");
        const searchIcon = document.querySelector(".search");
        const searchForm = document.querySelector(".form-search");
        const closeIcon = document.querySelector(".close");
        document.querySelector(".menu__icon");
        const block = document.querySelector(".side-menu");
        ...
        if (topheadeSearch) document.addEventListener("click", (function(e) {
            let targetElement = e.target;
            if (targetElement.closest(".top-header__search")) {
                searchForm.classList.toggle("_active");
                if (searchForm.classList.contains("_active")) {
        ...
        for (let i = 0; i < toolTip.length; i++) {
            toolTip[0].innerHTML = "Год 1959";
            toolTip[1].innerHTML = "Год 2022";
        }
        const scrollItem = document.querySelector(".scroll-top");
        document.querySelector(".last-anime");
        scrollItem.offsetHeight;
        window.addEventListener("scroll", test);
        function test() {
            const scrollTop = window.scrollY;
            if (scrollTop > 900) scrollItem.classList.add("_active"); else scrollItem.classList.remove("_active");
